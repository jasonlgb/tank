...
{
	this.lifetimes = 1; 
	document.querySelector("#life").innerHTML = this.lifetimes;
	this.isdead = false; 
	this.color = '#FF0000'; 
	this.x = x; 
	this.y = y; 
	this.direct = direct; 
	this.bulletsList = []; 
	this.maxBulletSize = 12; //玩家坦克子弹最大数为12
	this.newlife = null; 
} 

Hero.prototype = new Tank (0, 0, 0); //Hero将Tank中的方法和属性全部克隆了一遍
Hero.prototype.constructor = Hero; //Hero构造函数
...
function Enemy (x, y, direct) 
{
	...
	this.direct = direct; 
	this.bulletsList = []; 
	this.maxBulletSize = 1; //玩家坦克子弹最大数为1
